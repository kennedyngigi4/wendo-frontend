...
type FormValues = z.infer<typeof WorkingHoursSchema>;
...
const WorkingHoursClientPage = ({ branch_id, data }: WorkingHoursClientPageProps) => {
...
export default WorkingHoursClientPage;