...
import ProviderBookingForm from '@/app/dashboard/provider/_components/_bookings/provider-booking-form'
...
const BookingDetailsPage = async ({ params }: BookingDetailsPageProps) => {
    ...
    const data = await ApiRequests.get(`bookings/provprof_bookings/${id}/?owner_type=branch&branch_id=${activeWorkspace.id}`, session?.accessToken, true);
